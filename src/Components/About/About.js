...
const About = () => {
    return (
        <div>
            ...
            <div className='grid grid-cols-3 items-center justify-center justify-items-center mx-8 '>
                ...
                <img className='border-8 rounded-xl' src={shohidul} alt="" />
                <div className=' '>
                    <p>
            ...
            <div>
                ...
                <div className='grid grid-cols-5 text-6xl items-center justify-items-center gap-6 my-6'>
            ...
            <div>
                ...
                <div className='flex justify-between mx-16 text-5xl my-8 border border-primary p-6 '>
